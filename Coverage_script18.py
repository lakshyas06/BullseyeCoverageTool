        ...
        if(one_test in managedTestList):
            ...
            try:
                ...
                try:
                    ...
                    print(f"{cpID}:FINSIHED RUNTEST7")
                    os.chdir(setupDir)
                    ###################################### CHECK TEST STATUS ##############################################
                    #########################################################################################################
                        # 4. check status
